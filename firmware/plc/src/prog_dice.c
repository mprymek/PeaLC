...
IEC_BOOL led0, led1, led2, led3, switch_local;

void config_init__(void)
{
	common_ticktime__ = CHANGE_DELAY_MS * MILLISECOND_NS;

	// Connect output variables to IO buffer.
	uint8_t i = 0;
	...
	// Connect input variable to IO buffer.
	i = 0;
...
#ifdef DEBUG
		PRINTF("switch: %u\tleds: %u %u %u %u\n", switch_local, led0,
		       led1, led2, led3);
#endif
	}
}

#endif // defined(PROG_DICE)