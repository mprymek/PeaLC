...
uint8_t automation_set_dos(uint8_t source_node_id, uint8_t start_index, const bool *values, uint8_t len)
{
    for (int i = 0; i < len; i++)
    {
    ...
    PRINTS("DO"); PRINTU(start_index); PRINTS("-"); PRINTU(start_index+len);
    PRINTS(" :=");
    for (int i = 0; i < len; i++)
    {
        PRINTS(" "); PRINTU(values[i]);
    }
    PRINTS("\n");
#endif
...
uint8_t automation_set_aos(uint8_t source_node_id, uint8_t start_index, const uint16_t *values, uint8_t len)
{
    for (int i = 0; i < len; i++)
    {
...
#if LOGLEVEL >= LOGLEVEL_DEBUG
    PRINTS("AO"); PRINTU(start_index); PRINTS("-"); PRINTU(start_index+len);
    PRINTS(" :=");
    for (int i = 0; i < len; i++)
    {
        PRINTS(" "); PRINTU(values[i]);
...
uint8_t automation_get_dis(uint8_t source_node_id, uint8_t start_index, bool *values, uint8_t len)
{
    for (int i = 0; i < len; i++)
    {
...
uint8_t automation_get_ais(uint8_t source_node_id, uint8_t start_index, uint16_t *values, uint8_t len)
{
    for (int i = 0; i < len; i++)
    {
...
void automation_on_get_dis_response(uint8_t source_node_id, uint8_t start_index, bool *values, uint8_t len) {}
void automation_on_get_ais_response(uint8_t source_node_id, uint8_t start_index, uint16_t *values, uint8_t len) {}
